...
from ..einops import _apply_recipe
...
class RearrangeMixin:
    """
    Rearrange layer behaves identically to meinops.rearrange operation.

    :param pattern: str, rearrangement pattern
    :param axes_lengths: any additional specification of dimensions

    See meinops.rearrange for source_examples.
    """
...
class ReduceMixin:
    """
    Reduce layer behaves identically to meinops.reduce operation.

    :param pattern: str, rearrangement pattern
    :param reduction: one of available reductions ('min', 'max', 'sum', 'mean', 'prod'), case-sensitive
    :param axes_lengths: any additional specification of dimensions

    See meinops.reduce for source_examples.
    """
