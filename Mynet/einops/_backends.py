"""
Backends in `meinops` are organized to meet the following requirements
...
def get_backend(tensor) -> 'AbstractBackend':
    ...
    raise RuntimeError('Tensor type unknown to meinops {}'.format(type(tensor)))
...
class AbstractBackend:
    ...
    def __repr__(self):
        return "<meinops backend for {}>".format(self.framework_name)
